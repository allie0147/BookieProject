						...
						<div class="panel-group" id="accordion">
							...
							<div class="panel panel-default">
								...
								<div id="collapse3" class="panel-collapse collapse">
									<div class="panel-body">
										국내 최대 도서정보 공유포털사이트 북키는 안전한 회원정보 관리와 보다 나은<br> 서비스를 위해 매 주
										월요일에 정기점검을 실시합니다. 점검중에는 이용이 불가합니다<br> 점검 시간은 정오부터 2시간이며
										점검 종료 후 바로 이용이 가능합니다.
									</div>
								</div>
							</div>
						</div>
							...
							<div class="panel panel-default">
								...
								<div id="collapse2-2" class="panel-collapse collapse">
									<div class="panel-body">
										...
										방법으로 개인정보를 수집합니다.<br> 가. 회원 가입 및 서비스 이용과정에서 이용자가 개인정보 수집에
										대해 동의를 하고 직접 정보를 입력하는 경우<br> 나. 고객센터를 통한 상담 과정에서 웹페이지,
										메일, 팩스, 전화 등을 통해 회원이 개인정보를 제공하는 경우<br> 다. 오프라인에서 진행되는
										이벤트/행사에 회원이 참여하고 개인정보를 제공하는 경우<br> 라. 제휴 서비스 또는 단체 등으로부터
										개인정보를 제공받는 경우
									</div>
								</div>
							</div>
