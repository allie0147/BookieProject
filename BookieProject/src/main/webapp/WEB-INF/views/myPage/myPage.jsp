    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="div-container">
          ...
          <div class="container">
            <b>GENRE</b><br>
            <input type="checkbox" id="gen1" name="gen1" value="sosihe" disabled>
            <label for="gen1"> 소설, 시, 희곡</label>&nbsp;
            <input type="checkbox" id="gen2" name="gen2" value="esse" disabled>
            <label for="gen2"> 에세이</label>&nbsp;
            <input type="checkbox" id="gen3" name="gen3" value="inmoon" disabled>
            <label for="gen3"> 인문학</label>&nbsp;
            <input type="checkbox" id="gen4" name="gen4" value="inmoon" disabled>
            <label for="gen4"> 경제 경영</label><br>
            <input type="checkbox" id="gen5" name="gen5" value="inmoon" disabled>
            <label for="gen5"> 사회 과학</label>&nbsp;
            <input type="checkbox" id="gen6" name="gen6" value="inmoon" disabled>
            <label for="gen6"> 종교</label>&nbsp;
            <input type="checkbox" id="gen7" name="gen7" value="inmoon" disabled>
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-default" onclick="location.href='/bookie/mypageUpdate';">수정하기</button>
          </div>
        </div>
      </div>
    </div>
